...
"""Plan or build one closed CH25 psi Azure CPU phase package."""
...
from tg_verifier.azure_cpu_psi_materializer import (  # noqa: E402
    PsiMaterializerError,
    load_site,
    materialize,
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "psi_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
