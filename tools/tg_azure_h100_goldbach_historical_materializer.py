...
"""Plan or build one source-height historical Goldbach H100 measured job."""
...
from tg_verifier.azure_h100_goldbach_historical_materializer import (  # noqa: E402
    HistoricalGoldbachH100MaterializerError,
            ...
            json.dumps(
                {
                    "accepted": False,
                    "classification": (
                        "historical_goldbach_h100_materialization_failed_closed"
                    ),
                    "error": str(error),
                },
                sort_keys=True,
