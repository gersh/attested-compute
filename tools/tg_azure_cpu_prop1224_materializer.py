...
"""Plan or build one Proposition 12.2.4 Azure SEV-SNP CPU package."""
...
from tg_verifier.azure_cpu_prop1224_materializer import (  # noqa: E402
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "prop1224_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
