...
"""Plan or build one closed finite-Goldbach-below-10^27 CPU package."""
...
from tg_verifier.azure_cpu_goldbach_10pow27_materializer import (  # noqa: E402
    Goldbach10Pow27MaterializerError,
    load_site,
    materialize,
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "goldbach10pow27_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
