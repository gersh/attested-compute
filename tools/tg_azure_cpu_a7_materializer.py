...
"""Plan or build the closed CH25 A.7 Azure SEV-SNP CPU package."""
...
from tg_verifier.azure_cpu_a7_materializer import (  # noqa: E402
    A7MaterializerError,
    load_site,
    materialize,
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "a7_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
