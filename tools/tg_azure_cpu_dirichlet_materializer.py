...
"""Plan or build the closed Dirichlet fallback Azure SEV-SNP package."""
...
from tg_verifier.azure_cpu_dirichlet_materializer import (  # noqa: E402
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "dirichlet_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
