...
"""Plan, build, or audit the source-closed R2Star Azure H100 job."""
...
from tg_verifier.azure_h100_r2star_materializer import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    export = commands.add_parser(
        "export",
        help="authenticate and copy the signed retained full-source archive",
    )
    ...
    try:
        if args.command == "export":
            result = export_retained_campaign(
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "r2star_h100_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
