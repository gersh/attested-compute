...
"""Plan or build the closed Platt-head Azure SEV-SNP CPU package."""
...
from tg_verifier.azure_cpu_platt_head_materializer import (  # noqa: E402
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "accepted": False,
                    "classification": "platt_head_cpu_materialization_failed_closed",
                    "error": str(error),
                },
                sort_keys=True,
                separators=(",", ":"),
