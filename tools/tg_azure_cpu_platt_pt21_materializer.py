...
"""Plan or build one exact unscaled PT21 Azure CPU phase package."""
...
from tg_verifier.azure_cpu_platt_pt21_materializer import (  # noqa: E402
            ...
            json.dumps(
                {
                    "accepted": False,
                    "classification": (
                        "platt_pt21_cpu_materialization_failed_closed"
                    ),
                    "error": str(error),
                },
                sort_keys=True,
