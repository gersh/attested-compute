...
"""Plan or build one historical Goldbach operational Azure CPU workload."""
...
from tg_verifier.azure_cpu_goldbach_historical_operational_materializer import (  # noqa: E402
    HistoricalGoldbachOperationalMaterializerError,
    load_site,
    materialize,
            ...
            json.dumps(
                {
                    "accepted": False,
                    "classification": (
                        "historical_goldbach_operational_"
                        "materialization_failed_closed"
                    ),
                    "error": str(error),
                },
                sort_keys=True,
